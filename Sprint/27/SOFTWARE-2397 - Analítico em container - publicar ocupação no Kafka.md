...
tamanho: 2 pts
status: comprometido (sexta). Validado contra a develop em 03/08. PR aberta em draft: [#1350](https://github.com/atmanadmin/attlas-2026/pull/1350). ClickUp movido para `in progress`.
