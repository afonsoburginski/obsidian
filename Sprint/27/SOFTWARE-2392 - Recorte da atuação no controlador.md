...
tamanho: 2 pts
status: fila da Sprint 27 (backlog no ClickUp), docs-only. Aberto em 31/07 quando o levantamento mostrou que a ACOM já está implementada e o que falta é o caller.
sprint: "[[Attlas - Sprint 27]]"
atualizado: 2026-07-31
---

# SOFTWARE-2392 - Recorte da atuação no controlador
...
- [[SOFTWARE-2200 - Prova ponta a ponta do analítico desacoplado]], card irmão que ficou com a rota
  analítica.
- [[Attlas - Sprint 27]].
