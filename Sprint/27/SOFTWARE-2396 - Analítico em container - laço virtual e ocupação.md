...
tamanho: 2 pts
status: comprometido (quinta). Validado contra a develop em 03/08. PR aberta em draft: [#1349](https://github.com/atmanadmin/attlas-2026/pull/1349). ClickUp movido para `in progress`.
