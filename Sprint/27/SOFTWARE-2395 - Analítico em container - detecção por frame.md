...
tamanho: 3 pts
status: comprometido (quarta). Validado contra a develop em 03/08. PR aberta em draft: [#1347](https://github.com/atmanadmin/attlas-2026/pull/1347). ClickUp movido para `in progress`.
