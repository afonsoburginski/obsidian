...
tamanho: a estimar
status: to do. Movido da lista da Sprint 26 para a Sprint 27 no ClickUp em 03/08 (sprint 26 encerrou sem o card ser tocado; fica fora do foco único no analítico desta semana, mas precisa de lista ativa).
