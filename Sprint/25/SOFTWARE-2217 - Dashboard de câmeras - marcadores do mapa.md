...
---
**Spec** `apps/ms-cameras/docs/atomic/UC-037-dashboard-map-markers.md` · **PR** [#861](https://github.com/atmanadmin/attlas-2026/pull/861) (**MERGEADA** 25/07) · **ClickUp** Closed · review interno 24/07: fixes aplicados (1 commit) + atualizada com a develop
