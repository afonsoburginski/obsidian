...
tamanho: 3 pts
status: SEM PRAZO desde 10/08 (frente do analítico despriorizada; a Sprint 27 fechou sem entrega e a 28 foi para VMS e videowall externo). PR em draft segue aberta. Histórico: comprometido (terça). Validado contra a develop em 03/08. PR aberta em draft: [#1346](https://github.com/atmanadmin/attlas-2026/pull/1346). ClickUp movido para `in progress`.
