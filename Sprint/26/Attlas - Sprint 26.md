...
status: leva de QA (2317+2318+2319) validada via API+banco em 27/07; falta clique-a-clique no web-attlas. Comparativo Attlas 25x26 pausado (voltou pro backlog). SOFTWARE-2326 (PR #1058, Sprint 25, mergeada 25/07) já tinha ligado o front do dashboard ao backend real - incluindo realtime via Socket.IO/Redis - antes da leva de QA rodar; falta só o e2e visual (Kong do dev defasado).
