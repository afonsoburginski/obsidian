...
---
**Spec** `apps/ms-cameras/docs/atomic/UC-035-dashboard-uptime-series.md` · **PR** [#858](https://github.com/atmanadmin/attlas-2026/pull/858) (draft, base `develop`) · **ClickUp** Sprint 25 / to do
