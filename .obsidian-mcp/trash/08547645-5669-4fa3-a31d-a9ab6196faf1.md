...
# Kubernetes - Arquitetura (Mermaid)

Diagrama em código, espelhado de `infra/docs/arquitetura.mmd`. Versão editável em quadro: [[Kubernetes - Arquitetura.excalidraw|Excalidraw]]. Contexto: `kubernetes/docs/01-VISAO-GERAL.md`, `kubernetes/docs/03-PRODUCAO.md`, `kubernetes/docs/04-CI-CD.md`.
