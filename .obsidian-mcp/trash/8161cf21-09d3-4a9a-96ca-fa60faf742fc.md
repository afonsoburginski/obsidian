...
Resumo do hardware do cluster de **produção** (RKE2 HA 3+3). Cálculo completo, armazenamento e limites por serviço: `kubernetes/docs/02-DIMENSIONAMENTO.md` (seção 5 e seção 7). Operação no cliente: `kubernetes/docs/03-PRODUCAO.md`.
