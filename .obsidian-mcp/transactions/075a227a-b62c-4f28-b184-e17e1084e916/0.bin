...
> Camada de **push** do domínio [[Saúde e monitoramento]] (MOD-005): entrega ao vivo ao operador o estado que o healthcheck 24/7 produz. Parte de [[ms-cameras]]. Diagrama: [[00 - Geral - Módulo Cameras.excalidraw|diagrama geral]].
...
Ver [[Saúde e monitoramento]]. **Status não trafega por Kafka**: `attlas.cameras.status-changed` existe nas constantes/SPEC mas não tem producer ativo (ver [[ms-cameras]]).
...
[[ms-cameras]] · [[Saúde e monitoramento]] · [[PTZ e presets]] · [[Streaming]] · `kubernetes/docs/06-PROBLEMAS-IDENTIFICADOS.md`
