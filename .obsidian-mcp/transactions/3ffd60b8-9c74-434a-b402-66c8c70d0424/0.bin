...
> Como o monitoramento funciona por dentro. Hub: [[Saúde e monitoramento]]. Regras de negócio: [[Saúde da câmera - regras de negócio e contratos]]. Visual: [[03 - MOD-003 camera-health.excalidraw|diagrama]].
...
- grava linha no log de eventos e publica `CameraConnectivityHealthChangedEvent` no EventBus in-process → handler de realtime escreve no Redis e faz push WebSocket (ver [[Status em tempo real]]).
