...
Cadência de saúde: ping a cada `PING_INTERVAL_MS`→5 s, janela `PING_WINDOW_SIZE`→10; token wssession válido ~15 s; subscription PullPoint TTL `PT60S`. Detalhe de avaliação, incidentes e rollups em [[Saúde e monitoramento\|Saúde e monitoramento]].
</content>
