...
tamanho: 2 pts
status: SEM PRAZO desde 10/08 (frente do analítico despriorizada; a Sprint 27 fechou sem entrega e a 28 foi para VMS e videowall externo). PR em draft segue aberta. Histórico: fila da Sprint 27 (in progress no ClickUp). Reescopado em 31/07 - a atuação no controlador saiu para o SOFTWARE-2392 e o card virou a prova da rota analítica. Entra na sexta se o connector fechar na quinta. Validado contra a develop em 03/08, com a rota corrigida abaixo. PR aberta em draft (plano de teste): [#1357](https://github.com/atmanadmin/attlas-2026/pull/1357).
