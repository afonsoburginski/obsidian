...
tags:
  ...
  - infra
aliases:
  - "Provisionar cluster - Terraform RKE2"
atualizado: 2026-07-03
---

# Kubernetes - Provisionamento (Terraform RKE2)
...
**pods, via KEDA** (ver `infra/bootstrap/scaling/` e `kubernetes/docs/01-VISAO-GERAL.md` seção 4). O `var.max_pods` é só teto.
