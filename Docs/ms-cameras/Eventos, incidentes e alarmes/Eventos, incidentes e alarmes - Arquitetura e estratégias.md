...
> Contraste com os listeners de correlação/alarme (seção 4/seção 5): esses **relançam** erros não-swallowable para o Kafka reentregar. O ingest, não - prioriza não travar a ingestão.
