...
> Parte de [[Status em tempo real]]. Diagrama: [[00 - Geral - Módulo Cameras.excalidraw|diagrama geral]].
...
| # | Passo | Onde |
| --- | --- | --- |
| 1 | Worker de saúde detecta a mudança de status de conexão | `health/workers/camera-health.worker.ts` (ver [[Saúde e monitoramento]]) |
...
- **VMS:** cada célula assina a sua câmera; badge de status e overlay PTZ acompanham em tempo real (o vídeo em si vem do gateway de [[Streaming]]).
