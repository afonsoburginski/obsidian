...
Independentemente do protocolo de entrada (ONVIF ou RTSP), o descritor final é **sempre RTSP** - é o denominador comum que o pipeline de [[Streaming\|Streaming]] (ffmpeg → mediamtx) consome.
