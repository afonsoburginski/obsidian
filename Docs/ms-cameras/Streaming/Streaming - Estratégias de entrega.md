...
Volta para [[Streaming]] · [[ms-cameras]]. Irmãs: [[Streaming - Arquitetura]], [[Streaming - HLS]], [[Streaming - WebRTC e WHEP]], [[Streaming - Codecs e fallbacks]], [[Streaming - Fluxos e SLA]].
...
> devolvida ao player aponta para o HLS do mediamtx (ver [[Streaming - HLS]]).
